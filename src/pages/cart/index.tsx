...
export function Cart() {
  ...
  return (
    <div className="w-full h-full flex mx-auto items-center py-72 justify-end bg-transparent">
      <div className="w-full flex flex-col max-w-xl border-2 border-red  px-5 items-center justify-between bg-white z-10">
