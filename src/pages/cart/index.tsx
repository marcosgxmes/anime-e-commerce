              ...
              <div className="pointer-events-none fixed inset-y-0 right-0 flex max-w-full sm:pl-10">
                ...
                >
                  ...
                  <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl sm:rounded-l-3xl">
                    ...
                    {cart && (
                      <div className='relative flex overflow-y-auto px-5 pt-6 sm:px-6 bg-white'>
                    ...
                    <div className=" relative flex-1 overflow-y-auto px-5 pb-6 sm:px-6 ">
                            ...
                            {cart.map((item) => (
                              <section
                                ...
                                <div className='flex items-center justify-between px-3 py-1'>
                                  ...
                                  <button
                                    className='p-1 flex items-center gap-1 text-purple font-semibold text-sm'
